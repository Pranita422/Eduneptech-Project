    ...
    return (
        <section className="animate-in fade-in slide-in-from-bottom-2 duration-700">
            <div className="mb-10">
                ...
                <p className="text-slate-500 font-medium">Select a language to begin your guided learning path</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {languages.map((lang, index) => (
                    <div
                        key={index}
                        className="group relative bg-white rounded-[2.5rem] p-10 shadow-sm hover:shadow-2xl hover:shadow-indigo-100 transition-all duration-500 border border-slate-100 flex flex-col items-center text-center overflow-hidden hover:-translate-y-2 cursor-pointer"
                    >
                        ...
                        <div className="w-24 h-24 mb-8 relative">
                            {/* Decorative Glow */}
                            <div className="absolute inset-0 bg-slate-100 rounded-full scale-0 group-hover:scale-125 transition-transform duration-700 opacity-50"></div>
                        ...
                        <button className="relative z-10 w-full py-4 bg-slate-50 text-slate-600 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-indigo-600 hover:text-white hover:shadow-lg hover:shadow-indigo-200 transition-all duration-300">
                            Explore Curriculum
                        </button>
                    </div>
                ))}
